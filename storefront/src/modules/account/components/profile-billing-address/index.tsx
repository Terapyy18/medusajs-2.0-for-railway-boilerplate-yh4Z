...
import { updateBillingAddress } from "@lib/data/customer"
...
const ProfileBillingAddress: React.FC<MyInformationProps> = ({
  ...
  const [state, formAction] = useActionState(updateBillingAddress, {
    error: false,
    success: false,
    addressId: ""
  })
  ...
  return (
    <form action={formAction} onReset={() => clearState()} className="w-full">
      <AccountInfo
        label={dictionary.account.profile.billing_address}
